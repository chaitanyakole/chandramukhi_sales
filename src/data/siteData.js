...
export const PROJECTS = [
  { id: 1, cat: 'Roads', title: 'Pune–Nashik Expressway Stretch', loc: 'Pune, MH', year: 2023, desc: '2.4 km 4-lane stretch using advanced bituminous technology. Completed 3 weeks ahead of schedule.', value: '₹8.2 Cr', emoji: '🛣️', featured: true, proof: ['2.4 km executed', '4-lane corridor', 'QC lab checks'], outcome: 'Delivered 3 weeks early with smooth riding index compliance.' },
  { id: 2, cat: 'RMC',   title: 'Amanora Township Phase 3',      loc: 'Hadapsar, Pune', year: 2023, desc: '4,500+ cubic meters of M40 grade RMC for twin 18-storey residential towers.', value: '₹3.4 Cr', emoji: '🏗️', featured: true, proof: ['4,500+ m3 poured', 'M40 grade supply', 'Transit mixer dispatch tracking'], outcome: 'Continuous pour windows maintained with zero batch rejection reported.' },
  { id: 3, cat: 'Civil', title: 'MIDC Industrial Shed Complex',   loc: 'Chakan, Pune', year: 2022, desc: '15,000 sq.ft. industrial shed with RCC frame structure and overhead crane runway beams.', value: '₹5.1 Cr', emoji: '🏭', featured: true, proof: ['15,000 sq.ft. structure', 'RCC + steel coordination', 'Safety-first execution'], outcome: 'Factory-ready handover completed within the committed timeline.' },
  { id: 4, cat: 'Roads', title: 'Pimpri–Chinchwad Internal Roads', loc: 'PCMC, Pune', year: 2022, desc: '18 km internal road network for residential township including storm water drains.', value: '₹12 Cr', emoji: '🛣️', proof: ['18 km network', 'Drain integration', 'Phased execution'], outcome: 'Traffic-ready roads opened in phases to minimize resident disruption.' },
  { id: 5, cat: 'RMC',   title: 'Seasons Mall Expansion',         loc: 'Hadapsar, Pune', year: 2021, desc: 'High-slump M30 RMC for basement slab and multi-level parking structure.', value: '₹2.8 Cr', emoji: '🏗️', proof: ['High-slump mix support', 'Basement slab pour', 'Night-shift supply'], outcome: 'Large slab pours completed on schedule with consistent slump values.' },
  { id: 6, cat: 'Civil', title: 'Wagholi Flyover Ramp',           loc: 'Wagholi, Pune', year: 2021, desc: 'Substructure concrete and abutment work for 3-span highway flyover.', value: '₹9.5 Cr', emoji: '🌉', proof: ['3-span package', 'Abutment works', 'Engineer-supervised QC'], outcome: 'Critical ramp sections completed with smooth structural integration.' },
  { id: 7, cat: 'Roads', title: 'Solapur Highway Resurfacing',     loc: 'Solapur, MH', year: 2020, desc: '30 km highway overlay with milling & paving under MSRDC scheme.', value: '₹18 Cr', emoji: '🛣️', proof: ['30 km overlay', 'Milling + paving', 'MSRDC compliance'], outcome: 'Corridor handed over with improved lane quality and durability.' },
  { id: 8, cat: 'RMC',   title: 'Koregaon Park Luxury Residences', loc: 'Pune', year: 2020, desc: 'Pump-concrete delivery for G+22 luxury residential complex.', value: '₹4.2 Cr', emoji: '🏗️', proof: ['G+22 pump concrete', 'Peak-hour logistics', 'High-rise schedule support'], outcome: 'Pour continuity maintained across tower cycles without delays.' },
  { id: 9, cat: 'Civil', title: 'Zilla Parishad School Buildings', loc: 'Pune District', year: 2019, desc: '10 school buildings under Maharashtra government infrastructure scheme.', value: '₹6.8 Cr', emoji: '🏫', proof: ['10 campus units', 'Govt. standards', 'Multi-site team deployment'], outcome: 'Educational blocks completed to specification across all sites.' },
];
